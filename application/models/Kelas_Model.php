...
class Kelas_Model extends CI_Model
{
    ...
    // Fungsi Kelas
    public function get_kelas($order_by1 = 'nama_kelas', $order_by2 = 'kode_tingkat', $order_type = 'ASC')
    {
        $this->db->order_by($order_by1, $order_type);
        $this->db->order_by($order_by2, $order_type);
