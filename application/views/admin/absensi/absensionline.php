                    ...
                    <div class="card">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <form method="get" action="<?php echo base_url('admin/absensi/online'); ?>">
                                            <div class="row">
                                        ...
                                        <?php if (!empty($start_date) && !empty($end_date) && !empty($selected_kelas)) : ?>
                                            <div class="row mt-2">
                                                <div class="col-sm-12 text-end">
                                                    <a href="<?php echo base_url('admin/absensi/cetak_pdf_absensi_online?start_date=' . $start_date . '&end_date=' . $end_date . '&kelas=' . $selected_kelas); ?>" target="_blank" class="btn btn-secondary">
                                                        Cetak PDF
                                                    </a>
                                                </div>
                                            </div>
