...
<body class="hold-transition sidebar-mini layout-fixed layout-footer-fixed">
    ...
    <div class="card-header">
        <h3 class="card-title"><i class="fa-brands fa-cloudflare"></i> Absensi Bulanan Guru</h3>
    </div>
    <div class="card-body">
        <form method="get" action="<?php echo base_url('admin/rekapabsensiguru/rekapbulanguru'); ?>" class="mb-3">
            <div class="row">
                <div class="col-md-4">
                ...
                <tbody>
                    <?php if (!empty($absensibulan)) : ?>
                        ...
                        foreach ($absensibulan as $index => $itemabsen) : 
                            if ($current_nama != $itemabsen['nama_ptk']) :
                                $current_nama = $itemabsen['nama_ptk'];
                        ?>
                        <tr>
                            ...
                            foreach ($absensibulan as $absen) {
                                if ($absen['nama_ptk'] == $current_nama && date('n', strtotime($absen['timestamp'])) == $month && date('Y', strtotime($absen['timestamp'])) == $year) {
