...
<body>
    ...
    <div style="text-align: center;"><br>
        <span style="font-weight: bold;">DAFTAR KEHADIRAN GURU</span><br>
    </div>
    <table>
        <tr>
            <th></th>
    ...
    ?>
        <table border="1" cellpadding="3">
            <tr style="text-align: center; font-weight: bold;">
                ...
                <th rowspan="2" style="width: 110px; text-align: center;">NIP</th>
                <th colspan="9" rowspan="2" style="width: 70px;">Tanggal</th>
                <th colspan="9" rowspan="2" style="width: 60px;">Jam</th>
            ...
            foreach ($absensionline as $index => $data) : ?>
                <tr>
                    ...
                    <td style="font-size: 11px;"><?= $data['nama_ptk'] ?></td>
                    <td style="font-size: 10px; text-align: center;"><?= $data['nip'] ?></td>
                    <td style="font-size: 10px; text-align: center; width: 70px;">
                        <?php echo !empty($data['timestamp']) ? date('d-m-Y', strtotime($data['timestamp'])) : ''; ?>
                    </td>
                    <td style="font-size: 10px; text-align: center; width: 60px;">
                        <?php echo !empty($data['timestamp']) ? date('H:i:s', strtotime($data['timestamp'])) : ''; ?>
                    </td>
