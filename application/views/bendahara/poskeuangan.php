                ...
                <div class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title"><i class="fa-solid fa-coins"></i> Data POS Keuangan </h3>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($poskeuangan as $index => $poskeuangan): ?>
                                    <tr>
                                        <td class="text-center"><?php echo $index + 1; ?></td>
                                        <td class="text-center"><?php echo $poskeuangan['nama_pos']; ?></td>
                                        <td class="text-center"><?php echo $poskeuangan['ket_pos']; ?></td>
                                        <td class="text-center">
                                            <a class="btn btn-danger btn-sm" href="#" onclick="deletePos(<?php echo $poskeuangan['id_pos']; ?>)"><i class="fas fa-trash"></i></a>
                                            <a class="btn btn-success btn-sm" href="#" onclick="editPos(<?php echo $poskeuangan['id_pos']; ?>)"><i class="fas fa-edit"></i></a>
