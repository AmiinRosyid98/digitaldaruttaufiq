                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="card-title"><i class="fa-solid fa-money-check-dollar"></i> Tarif Pembayaran </h3>
                            </div>
                            </div>
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach ($tarifpembayaran as $index => $tarifpembayaran): ?>
                                        <tr>
                                            <td class="text-center"><?php echo $index + 1; ?></td>
                                            <td class="text-center"><?php echo $tarifpembayaran['nama_pos']; ?></td>
                                            <td class="text-center"><?php echo $tarifpembayaran['nama_kelas']; ?></td>
                                            <td class="text-center"><span class="badge bg-success" style="font-size: 15px;"><?php echo $tarifpembayaran['tahun_pelajaran']; ?></span></td>
                                            <td class="text-center"><?php echo 'Rp ' . number_format($tarifpembayaran['jumlah_tarif'], 0, ',', '.'); ?></span></td>
                                            <td class="text-center"><?php echo $tarifpembayaran['nama_tipepembayaran']; ?></td>
                                            <td class="text-center"><a class="btn btn-danger btn-sm" href="#" onclick="deleteTarifpembayaran(<?php echo $tarifpembayaran['id_pembayaran']; ?>)"><i class="fas fa-trash"></i></a></td>
...
<?php $this->load->view('bendahara/_partials/footer.php') ?>
    ...
    <script>  //Fungsi Mengambil ID id_jenispembayaran
    ...
    <script> //Fungsi Hapus TARIF PEMBAYARAN
        function deleteTarifpembayaran(tarifpembayaranId) {
            Swal.fire({
                title: 'Apakah Anda yakin?',
                text: "Tarif Pembayaran ini akan terhapus permanen !",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?php echo base_url('/bendahara/datakeuangan/hapus_tarifpembayaran/'); ?>" + tarifpembayaranId; 
                }
            });
        }
    </script>
