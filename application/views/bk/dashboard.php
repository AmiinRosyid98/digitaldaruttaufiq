                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div class="info-box mb-3 bg-danger">
                                                    <span class="info-box-icon elevation-5" style="color: #ffffff;"><i class="fas fa-hand"></i></span>
                                                    <div class="info-box-content" style="background-color: #FFFFFF; color: #000000;">
                                                        <span class="info-box-text font-weight-bold">Jenis Pelanggaran</span>
                                                        <span class="info-box-number"><?php echo $total_jenispelanggaran; ?> Jenis</span>
                                                        <span class="info-box-text">Sinkronisasi Server</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div class="info-box mb-3 bg-dark">
                                                    <span class="info-box-icon elevation-5" style="color: #ffffff;"><i class="fas fa-street-view "></i></span>
                                                    <div class="info-box-content" style="background-color: #FFFFFF; color: #000000;">
                                                        <span class="info-box-text font-weight-bold">Melakukan Pelanggaran</span>
                                                        <span class="info-box-number"><?php echo $total_pelanggaran; ?> Siswa</span>
                                                        <span class="info-box-text">Sinkronisasi Server</span>
                                                    </div>
                                                </div>
                                            </div>
