        ...
        <div class="relative flex-1 p-8 bg-[#006A6D] text-white flex flex-col justify-between rounded-l-2xl lg:w-2/5 md:w-full sm:w-full">
            ...
            <div class="flex-grow flex flex-col justify-center">
                ...
                <form id="loginForm" class="space-y-4">
                    ...
                    <div>
                        <input type="password" id="password" placeholder="Password" class="w-full p-3 rounded-xl bg-[#005456] text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-[#FFC200]">
                    </div>
