...
<head>
  ...
  <title><?php foreach ($profil_array as $row) : ?><?php echo $row['nama_lembaga']; ?><?php endforeach; ?> - Bimbingan Konseling</title>
    ...
    <div class="row">
      ...
      <div class="col-md-6 bg-white d-flex align-items-center justify-content-center position-relative">
        ...
        <div class="w-100 col-md-8">
          <p class="text-left" style="color:#087990"><u><strong style="font-size: 50px;">Login</strong></u><span class="text-left text-2xl" style="color:#3F6F81"><strong style="font-size: 25px;">Bimbingan Konseling</strong></span></p>

          <form action="loginbk" method="post">
            <div class="container">
              <div class="input-group mb-3">
                ...
                <input type="hidden" name="role" class="form-control" value="bk">
              </div>
              <div class="input-group mb-3">
                <div class="input-group-prepend">
