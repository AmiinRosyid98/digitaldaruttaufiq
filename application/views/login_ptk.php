...
<body>
  <div class="login-container">
    ...
    <div class="login-left animate__animated animate__fadeIn">
      ...
      <p class="login-subtitle animate__animated animate__fadeInUp animate__delay-1s">Sistem Administrasi Sekolah</p>
    ...
    <div class="login-right">
      <div class="neuro-card animate__animated animate__fadeInRight">
        <img src="<?php echo base_url() ?>/assets/web/logo-kit.png" alt="Admin Logo" style="height: 60px; margin-bottom: 20px; display: block; margin-left: auto;">

        <h1 class="admin-title">PTK Login</h1>
        <p class="admin-subtitle">Masukkan kredensial Anda untuk mengakses panel</p>

        <form action="loginptk" method="post">

          <div class="input-container">
            <div class="input-wrapper">
              <i class="fas fa-user input-icon"></i>
              <input type="text" name="username" id="username" class="liquid-input" placeholder=" " value="<?= set_value('username') ?>" required>
          ...
          <div class="input-container">
            <div class="input-wrapper">
              ...
              <input type="password" name="password" id="password" class="liquid-input" placeholder=" " value="<?= set_value('password') ?>" required>
